---
title: "Gestión de Usuarios Backoffice"
description: "Administra los usuarios con acceso al panel de administración (backoffice) del sistema Tangerine"
icon: "user-gear"
---
...
<Steps>
  ...
  <Step title="Navega a Usuarios Backoffice">
    En el menú lateral izquierdo, haz clic en el icono de **Usuarios Backoffice** o navega a la sección correspondiente en el menú de usuarios.
...
| **Rol** | Tipo de rol de administración asignado |
...
<AccordionGroup>
  ...
  <Accordion title="Desactivar un administrador que dejo la organización">
...
<Warning>
  ...
  **Solución:** Verifica que tu rol tenga permisos de gestión de usuarios backoffice. Solo ciertos roles de administración pueden crear otros administradores.
</Warning>

<Warning>
  **Problema:** El email ya existe en el sistema.

  **Solución:** Cada usuario debe tener un email único. Busca si el usuario ya existe en la lista o utiliza un email diferente.
</Warning>

<Warning>
  **Problema:** Un usuario no puede acceder al editor Mint.

  **Solución:** Verifica que el usuario tenga la **Licencia Mint** activada en su ficha de edición.
</Warning>
...
{/*
  ...
  - Sección UI: Usuarios > Usuarios Backoffice
  - Ruta: /users-admin
