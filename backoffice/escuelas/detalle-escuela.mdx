...
![Pestaña Programas Escuela con publicación asignada](/assets/screenshots/backoffice/escuelas/detalle-escuela-tab-programas-escuela.png)
...
<Steps>
  <Step title="Abrir el diálogo de búsqueda">
    ...
    ![Diálogo de búsqueda de programas](/assets/screenshots/backoffice/escuelas/dialogo-anadir-programa-busqueda.png)
  </Step>
  <Step title="Buscar y seleccionar programas">
    ...
    ![Programa seleccionado en el diálogo](/assets/screenshots/backoffice/escuelas/dialogo-anadir-programa-seleccion.png)
  ...
  <Step title="Configurar licencias de uso">
    ...
    ![Configuración de licencias de uso](/assets/screenshots/backoffice/escuelas/dialogo-anadir-programa-licencias-completo.png)
...
{/*
  ...
  - Archivos de código relacionados:
    ...
    - SchoolFormContents: tangerine-backoffice/src/app/modules/schools/SchoolForm/SchoolFormContents/
    - crud: tangerine-backoffice/src/app/crud/schools.crud.js
    - crud contents: tangerine-backoffice/src/app/crud/schoolsContents.crud.js
